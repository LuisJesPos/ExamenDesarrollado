...
go
/** el procedimiento almacenado esta al final*/
...
as
select t.TipoDocumento, t.NumeroDocumento, t.Nombres, t.Sexo, d.NombreDepartamento, p.NombreProvincia, ds.NombreDistrito from 
       Trabajadores t join Departamento d on t.IdDepartamento = d.Id
	   join Provincia p on t.id= p.Id
	   join Distrito ds on t.IdDistrito= ds.Id   
go
